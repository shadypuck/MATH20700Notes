...
\begin{itemize}
    \item \marginnote{10/24:}\textbf{Coordinates} (of $\vm\in V$ wrt. a basis $\vm_1,\dots,\vm_n$ of $V$): The unique scalars $\alpha_1,\dots,\alpha_n\in\F$ such that $\vm=\alpha_1\vm_1+\cdots+\alpha_n\vm_n$.
